...
import static j02LambdaAction.dsl.Dish.menu;
import static j02LambdaAction.dsl.Grouping.GroupingBuilder.groupOn;
...
public class Grouping {
    ...
    private static Map<Dish.Type, Map<CaloricLevel, List<Dish>>> groupDishedByTypeAndCaloricLevel3() {
        Collector<? super Dish, ?, Map<Dish.Type, Map<CaloricLevel, List<Dish>>>>
                c = groupOn((Dish dish) -> getCaloricLevel(dish)).after(Dish::getType).get();
